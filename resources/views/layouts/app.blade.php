...
<body class="header-fixed sidebar-fixed aside-menu-fixed aside-menu-hidden login-page">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <a class="navbar-brand" href="#">CL Team</a>
        ...
        <div class="collapse navbar-collapse" id="navbarColor01">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('album') }}">Photo</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('comment') }}">Commentaire</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('presentation') }}">CL Team</a>
                </li>
            </ul>

            <a href="{{ route('connexion') }}">Connexion</a>
            <a class="nav-link" href="{{ route('register') }}">Créer mon compte</a>
